...
const AllProductsCard = ({item}) => {
    const {product_name, product_image, price, ratings, availability, specifications, category, short_description, _id} = item;
    return (
        <div>
           <section className=''>
               ...
               <p>{price} $</p>
                <p className="flex items-center gap-1.5 font-sans text-base font-normal leading-relaxed text-blue-gray-900 antialiased">
                    ...
                    <div className="mb-3 flex items-center justify-between">
                        ...
                        <p className='text-xs text-center border-2 px-2 rounded-full bg-pink-200'>{category}</p>
                    </div>
