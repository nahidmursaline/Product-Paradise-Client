    ...
    return (
      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4">
        <div className="flex items-center mb-4 lg:mb-0">
          ...
          <h2 className="text-white text-xl font-bold">Product Paradise</h2>
        </div>
        <div className="text-white mb-4 lg:mb-0">
          <p className="mb-2">Contact us:</p>
          <p className="mb-2">Phone: 01741-****</p>
          <p className="mb-2">Email: productparadise@gmail.com</p>
      ...
      <div className="container mx-auto text-center mt-12">
        <p className="text-gray-400">&copy; {new Date().getFullYear()} Product Paradise. All rights reserved.</p>
      </div>
    </footer>
    );
};
