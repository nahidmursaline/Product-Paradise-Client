...
const ProductDetails = () => {
    ...
    const {product_name, product_image, price, ratings, availability, specifications, category, short_description, _id} = productDetails;
    return (
        <div>
            ...
            <h2 className='text-center text-3xl '>Details of {product_name}</h2>
                <div className=" relative mx-4 mt-4 overflow-hidden rounded-xl bg-blue-gray-500 bg-clip-border text-white shadow-lg shadow-blue-gray-500/40">
                   
                    <img
                        src={product_image}
                        alt="ui/ux review check"
                        className="h-[430px] w-full group-hover:scale-110   "
                    />
               ...
               <p>{price} $</p>
                <p className="flex items-center gap-1.5 font-sans text-base font-normal leading-relaxed text-blue-gray-900 antialiased">
                    ...
                    <div className="mb-3 flex items-center justify-between">
                        ...
                        <p className='text-center text-base border-2 px-2 rounded-full bg-pink-200'>{category}</p>
                    </div>
